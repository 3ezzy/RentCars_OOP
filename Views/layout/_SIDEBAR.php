...
<div class="bg-[#2a2455] lg:rounded-md shadow-lg w-full flex items-center justify-between fixed left-0 bottom-0 md:static md:block md:h-screen md:flex-col md:w-1/5 lg:w-1/6 md:p-4 text-white">
